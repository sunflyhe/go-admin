...
// parseAvatarUpload 从 multipart 请求提取头像文件,统一施加个人中心头像的大小上限。
// 成功时同时返回需由调用方关闭的文件句柄。
func parseAvatarUpload(c *gin.Context) (*service.AvatarInput, io.Closer, bool) {
...
func (h *AuthHandler) UploadAvatar(c *gin.Context) {
	...
	url, err := h.Profile.UploadAvatar(c.Request.Context(), actor, *in)
	if err != nil {
		resp.Fail(c, err)
		return
	}

...
// API 基础地址:admin 端固定走 /admin-api(与 app 端的 /api 区分);
// 前后端分域部署时在 .env 设置 VITE_API_BASE_URL 覆盖
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || '/admin-api'

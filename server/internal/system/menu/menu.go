...
func (s *Service) Tree(c *gin.Context) ([]MenuNode, error) {
	return LoadVisibleTree(s.DB.WithContext(c), true)
}

func (s *Service) ListAll(c *gin.Context) ([]model.SysMenu, error) {
	return LoadAll(s.DB.WithContext(c))
}

func (s *Service) Create(c *gin.Context, req *SaveReq) (*model.SysMenu, error) {
	if req.ParentID != 0 {
...
func (s *Service) Update(c *gin.Context, id int64, req *SaveReq) (*model.SysMenu, error) {
	var m model.SysMenu
...
func (s *Service) checkParent(c *gin.Context, parentID int64, childType int) error {
